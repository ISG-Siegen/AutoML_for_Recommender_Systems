...
def load_amazon_instantvideo_from_file():
    data = pd.read_table(os.path.join(get_dataset_default_location(), 'ratings_Amazon_Instant_Video.csv'), sep=',',
...
def load_amazon_instantvideo_from_csv():
    data = pd.read_table(os.path.join(get_dataset_default_location(), 'csv_files/amazon-instantvideo.csv'), sep=',',
